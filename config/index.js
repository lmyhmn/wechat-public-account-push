export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx9b9ca690a767bdc5",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "9ed0e2c7d35a203b919fe27c7f4f45ec",
   ...
   */
  USERS: [ozC9R6fivcymRBIwHIV2Zd3T1cA8
    {
      // 想要发送的人的名字
      name: "老婆0",
      ...
      id: "",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "guk3W4oRrD1CUvtPLkDk09dNYZZwTmULWlB6O5uv8kY",
      // 所在省份
      province: "安徽",
      // 所在城市
      city: "合肥",
  ...
  CALLBACK_TEMPLATE_ID: "ozC9R6fivcymRBIwHIV2Zd3T1cA8",
